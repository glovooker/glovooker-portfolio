          ...
          <div className='flex'>
            <div className='lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center'>
              ...
              <div className='lg:col-start-2 lg:max-w-2xl ml-auto pl-10'>
                <p
                  className={ `text-base leading-6 ${ currentProject.textColor != ''
                    ...
                    return (
                      ...
                      >
                        <div className='flex items-center'>
                          <span
                            className={ `flex-shrink-0 flex items-center justify-center h-9 w-9 rounded-full text-white ${ tag.tagBgColor }` }
                          >
                            { <tag.tagIcon className='h-5 w-5' /> }
                          </span>
                          <span className='ml-2 hidden md:block text-xs leading-3 font-medium text-gray-500'>
                            { tag?.tagName }
                          </span>
                        </div>
                      </li>
